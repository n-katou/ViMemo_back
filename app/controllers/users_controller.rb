class UsersController < ApplicationController
  ...
  def mypage
    ...
    youtube_video_urls = @youtube_video_likes.map { |like| like.likeable.youtube_id }
    @youtube_playlist_url = "https://www.youtube.com/embed?playlist=#{youtube_video_urls.join(',')}&autoplay=1"
